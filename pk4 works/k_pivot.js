/* 
  * there is changes in this plugin
*/
...
(function() {
  ...
  */
  ...
  aggregators = {
    ...
    sumOverSum: aggregatorTemplates.sumOverSum(2),
  ...
  */
  $.fn.pivotUI = function(input, inputOpts, overwrite) {
    ...
    for (x in _ref3) {
      ...
      aggregator.append($("<option>").val(x).text(x.charAt(0).toUpperCase() + x.slice(1))); //shoib: added code to capitalize first letter
    }
