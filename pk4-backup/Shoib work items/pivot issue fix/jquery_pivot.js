...
var methods = {
  setup   : function(options){
    piv_element = this; // set element for build_containers()
  ...
  update_results : function(){
	...
	try
	{
	    var result_table = $('#'+currentPivot), result_rows;
	}
	catch (e)
	{
		var result_table = $('#results'), result_rows;
	}
    result_table.empty();

	try
	{
		snip += '<table id="pivot-table-'+currentPivot+'" class="table table-striped table-condensed"><thead>';
	}
	catch (e)
	{
	...
	try
	{
	   snip += '</thead></tr><tbody id="result-rows-'+currentPivot+'"></tbody></table>';
	}
	catch (e)
	{
   ...
   try
	{
	    result_rows = $('#result-rows-'+currentPivot);
	}
	catch (e)
	{
