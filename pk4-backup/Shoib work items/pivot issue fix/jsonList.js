...
//	topMenuTr.innerHTML+="<td class=\"listButtons refresh\" onclick='reloadCurrentPage();' title='Reload'>&nbsp;</td>";
	...
	if(data.PageType=="List" && data.UDMName=="custom/adhocReports/reportView" && data.UserCanAddAdhoc == 1)
	{
			...
			var adHocReportMnuDiv = CreateDIV(adHocCreateReportTd, 'hover-menu', "categories-menu","New Report based on...  ", "130px");
			adHocReportMnuDiv.style.position = "relative";
			adHocReportMnuDiv.style.display = "block";
			var adHocReportMnuUL = CreateUL(adHocReportMnuDiv, 'actions no-style');
			...
			var adHocReportMnuNames = new Array("Accounts","Activities","Contacts","Leads","Loyalty Programs","Marketing Programs","Opportunities","Tickets","Users","Products"); 
			var adHocReportEnttName = new Array("accounts","activities","contacts","leads","loy_program","mktg_program","opportunities","tickets","sbeuser","product");
			var adHocReportEnttImg = new Array("/atCRM/images/Icon_Account.gif","/atCRM/images/Icon_activity.gif","/atCRM/images/Icon_Contact.gif","/atCRM/images/icon_lead2.gif","/atCRM/images/icon_loyalty.PNG","/atCRM/images/Icon_marketing.gif","/atCRM/images/Icon_Opportunity.gif","/atCRM/images/Icon_ticket.gif","/atCRM/images/icon_meeting.gif","/atCRM/images/Icon_Product.gif");
