	...
	if(totalColCntDt == true) {
		...
		for(var i=0, fc="dpass"; i<colHdrLen; i++, fc="") {
			...
			if($.inArray(dataTblHdr[i]['sClass'], colTotReq) != -1 ) {
				...
				td = '<td class="'+fc+'" style="font-weight:bold;padding:3px 18px 3px 10px;min-width:60px;max-width:60px;">'+ t+ '</td>'; //dataTblHdr[i]['sTitle'] 
			}
