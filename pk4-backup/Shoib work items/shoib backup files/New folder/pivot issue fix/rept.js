...
/*  Set up the chart*/ 
	//set some details of charts
	// adHchart['title']['text'] = rptName; //set title
	// adHchart['subtitle']['text'] = rptSubName; //set sub title
	// adHchart.chart['renderTo'] = 'tabChartArea'; //setting where to plot
	// console.log(adHchart);
	...
	globalChartPlotted = new Highcharts.Chart(globalChartObj); //this will plot the chart on load
