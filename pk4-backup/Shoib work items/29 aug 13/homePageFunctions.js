...
// function showSubmenusOnHover(hash) {
// 	if(hash)
// 	{
// 			var L_hashArr = hash.split("?");
// 			var L_historyGrp  = L_hashArr[0];
// 			var L_historyData = L_hashArr[1].split("&");
// 			L_menuId = getValues("menuId",L_historyData);
// 			checkMenuOrderForHover(L_menuId);
// 	}
// }

// function checkMenuOrderForHover(L_menuId) {
// 	var inDropDown = true;
// 	L_mnuID = L_menuId.split('mnuList_')[1];
...
// 	else
// 	{
// 		showMainMenuForHover(L_menuId);
// 	}
// }


// function showMainMenuForHover (objId,historyFlg,reloadFlag) 
// {
// 	try
// 	{
...
// 		showSubMenuForHover(subMenuId,'','main','',reloadFlag);
// 	}
// 	catch (e)
// 	{
...
// function showSubMenuForHover (objId,uri,fromMnu,dropIndex,reloadFlag) 
// {
